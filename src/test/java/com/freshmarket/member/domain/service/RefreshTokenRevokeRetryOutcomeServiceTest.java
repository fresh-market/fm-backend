...
class RefreshTokenRevokeRetryOutcomeServiceTest {

    @Mock
    private RefreshTokenRevokeFailureRepository failureRepository;

    private RefreshTokenRevokeRetryOutcomeService sut;

    @BeforeEach
    void setUp() {
        sut = new RefreshTokenRevokeRetryOutcomeService(failureRepository);
    }
