...
import com.freshmarket.coupon.internal.audit.CouponConsistencyReport;
...
import com.freshmarket.coupon.internal.dto.AdminCouponConsistencyCheckResponse;
...
import com.freshmarket.coupon.internal.repository.CouponConsistencyRepository;
...
public class CouponConsistencyService {
     ...
     *
     * @throws com.freshmarket.coupon.internal.exception.CouponException 그 쿠폰이 없으면
     */
    @Transactional(readOnly = true)
