package com.freshmarket.coupon.internal.batch;

import com.freshmarket.coupon.internal.service.CouponConsistencyService;
...
public class CouponConsistencyScheduler {
     ...
     *
     * 순번의 연속성은 이벤트가 도는 중에는 일시적으로 결번이 있는 것으로 잡힌다. 번호를 받고
