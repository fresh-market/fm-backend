...
public class MemberCouponExpireScheduler {
    ...
    /*
     * 한 실행이 도는 청크 수에 상한을 둔다.
     * 없으면 대상이 아주 많을 때 이 실행이 끝나지 않아 다음 배치가 밀리고, 종료 신호도 못 받는다.
     * 남은 것은 다음 실행이 이어서 가져간다.
     */
    ...
    /*
     * 반복이 여기 있는 이유가 있다.
     * 청크 하나가 트랜잭션 하나여야 하는데, 서비스가 자기 메서드를 부르면 프록시를 안 거쳐
