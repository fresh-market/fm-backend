...
import static com.freshmarket.stock.internal.entity.QStockLot.stockLot;
...
import com.freshmarket.stock.internal.dto.QCampaignTargetLotCandidate;
 ...
 *
 * findByProductOptionIds()는 정렬이 expiryDate(FEFO)라 정렬 축과 커서 축이 갈려,
 * id를 동점 처리 키로 함께 쓴다.
 */
@Repository
